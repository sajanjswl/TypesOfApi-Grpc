...
var fileDescriptor_239e7807ac1d8e6c = []byte{
	...
	0x13, 0xa5, 0xe4, 0x71, 0xca, 0x43, 0xac, 0x56, 0x62, 0xd0, 0x60, 0x4c, 0x62, 0x03, 0x07, 0x9c,
	0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xc9, 0xa4, 0xd2, 0xcd, 0x49, 0x01, 0x00, 0x00,
}
...
func (x *greetServiceGreetManyTimesClient) Send(m *GreetManyTimesRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceGreetManyTimesClient) CloseAndRecv() (*GreetManyTimesResponse, error) {
...
func (*UnimplementedGreetServiceServer) GreetManyTimes(srv GreetService_GreetManyTimesServer) error {
...
func (x *greetServiceGreetManyTimesServer) SendAndClose(m *GreetManyTimesResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceGreetManyTimesServer) Recv() (*GreetManyTimesRequest, error) {
